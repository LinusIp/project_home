...
const LEVELS = {
  B: { key:'B', name:'Basement', sheet:'A-101', ffl:-3.5, h:3.5,
       outline:[[8,10],[42,10],[42,42],[34,42],[34,32],[30.5,32],[30.5,21],[16,21],[16,37],[1.5,37],[1.5,26],[8,26]] },
...
const ROOMS = [
  /* BASEMENT  FFL -3.50 — the rooms of the engineering-lab basement board, plus core, lobbies and plant */
  {id:'B.01', lvl:'B', n:'Garage (4 Cars)', k:'garage', r:[[1.5,26,14.5,11]],
   d:'Four bays off a straight 6 m aisle that continues the ramp, plus an EV charging and wash bay. Polished power-floated concrete, flush trench drains and linear LED recessed into the soffit.'},
  {id:'B.02', lvl:'B', n:'Engineering Workshop', k:'service', r:[[35.5,19,6.5,9.5]],
   d:'A fitted workshop with a central workbench, full-height tool wall, a small CNC mill and a robot-arm test cell, with its own extract and three-phase power.'},
  {id:'B.03', lvl:'B', n:'Electronics Lab', k:'service', r:[[35.5,28.5,6.5,4.5]],
   d:'Two ESD-safe benches with fume extraction, bench power supplies and test instruments, next to the server room.'},
  {id:'B.04', lvl:'B', n:'Server Room', k:'plant', r:[[35.5,33,6.5,2.6]],
   d:'Three 42U racks with N+1 in-row precision cooling, a 10 kVA online UPS, overhead ladder tray and clean-agent gas suppression on its own detection loop.'},
  {id:'B.05', lvl:'B', n:'Gym', k:'live', r:[[15,10,7,9]],
   d:'Rubber floor, three cardio machines, a free-weight rack and a stretching zone, with fresh air at 6 air changes per hour and circadian LED coves.'},
  {id:'B.06', lvl:'B', n:'Cinema', k:'live', r:[[8,10,7,9]],
   d:'Black-box room with a 4 m acoustically transparent screen and nine recliners, built room-in-room on neoprene isolators so a 105 dB soundtrack never reaches the bedrooms.'},
  {id:'B.07', lvl:'B', n:'Electrical Room', k:'plant', r:[[38,14.5,4,4.5]],
   d:'Main LV switchboard, the automatic transfer switch for the standby generator and the building management controller.'},
  {id:'B.08', lvl:'B', n:'Water Tank Room', k:'plant', r:[[38,10,4,4.5]],
   d:'Two sectional water tanks with a booster set and UV steriliser, holding a day of supply plus a firefighting reserve.'},
  {id:'B.09', lvl:'B', n:'Sauna', k:'wet', r:[[22,10,2.7,4.5]],
   d:'Finnish sauna lined in thermally treated aspen, off the wellness lobby beside the gym.'},
  {id:'B.10', lvl:'B', n:'Shower', k:'wet', r:[[24.7,10,2.3,4.5]],
   d:'Two rain showers and a basin serving the sauna and the gym.'},
  {id:'B.11', lvl:'B', n:'Wine Cellar', k:'store', r:[[8,19,5,7]],
   d:'Held at 13 °C and 65 % RH by its own split unit, with black steel racking and a tasting table for six.'},
  {id:'B.12', lvl:'B', n:'Storage / Equipment', k:'store', r:[[35.5,39,6.5,3]],
   d:'Equipment and spares store on steel shelving at the end of the staff spine.'},
  {id:'B.13', lvl:'B', n:'Staff Room', k:'staff', r:[[35.5,35.6,4,3.4]],
   d:'Staff bedroom with a daylight tube, wardrobe and desk, with its own bathroom.'},
  {id:'B.14', lvl:'B', n:'Bathroom', k:'wet', r:[[39.5,35.6,2.5,3.4]],
   d:'Shower, WC and basin, opening off the staff room.'},
  {id:'B.15', lvl:'B', n:'Lift + Service Stair', k:'core', r:[[27,10,3.5,5.5]],
   d:'Concrete core from basement to roof: an 8-person lift and an enclosed service stair, the fire-rated escape route from the basement.'},
  {id:'B.16', lvl:'B', n:'Basement Lobby', k:'circ', r:[[27,15.5,3.5,3.5]],
   d:'Pressurised lift lobby that keeps smoke out of the stair core.'},
  {id:'B.17', lvl:'B', n:'Circulation', k:'circ', r:[[22,14.5,5,4.5]],
   d:'Wellness lobby joining the gym, sauna and shower to the service corridor.'},
  {id:'B.18', lvl:'B', n:'Mechanical Plant', k:'plant', r:[[30.5,10,7.5,9]],
   d:'Chilled-water plant, air-handling unit with heat recovery, heat pumps and the 250 kVA standby generator, louvred up to the service yard.'},
  {id:'B.19', lvl:'B', n:'Pool Plant Room', k:'plant', r:[[30.5,21,3.5,11]],
   d:'Hidden beneath the east pool deck: 12 m³ balance tank, variable-speed pumps, glass-media filters, UV steriliser, salt chlorinator and heat pump.'},
  {id:'B.20', lvl:'B', n:'Service Corridor', k:'circ', r:[[13,19,21,2]],
   d:'Runs under the main terrace to link garage, core, wellness, plant and the lab wing without crossing family space.'},
  {id:'B.21', lvl:'B', n:'Staff Spine', k:'circ', r:[[34,19,1.5,23]],
   d:'Private corridor serving the workshop, lab, server room, staff room and storage.'},
  {id:'B.22', lvl:'B', n:'Car Lobby', k:'circ', r:[[13,21,3,5]],
   d:'Fire-rated airlock between the garage and the house, with a bench and shoe store.'},
